 ...
 *
 * $jLastChangedDate: 2007-03-27 22:29:43 +0100 (Tue, 27 Mar 2007) $j
 * $jRev: 1601 $j
 */
 ...
 *
 * @example $j("#testdiv").height()
 * @result 200
 *
 * @example $j(document).height()
 * @result 800
 *
 * @example $j(window).height()
 * @result 400
 *
 * @name height
 * @type Object
 ...
 * See core docs on height() to see what happens when used on an element.
 *
 * @example $j("#testdiv").width()
 * @result 200
 *
 * @example $j(document).width()
 * @result 800
 *
 * @example $j(window).width()
 * @result 400
 *
 * @name width
 * @type Object
 ...
 *
 * @example $j("#testdiv").offset()
 * @result { top: 100, left: 100, scrollTop: 10, scrollLeft: 10 }
 *
 * @example $j("#testdiv").offset({ scroll: false })
 * @result { top: 90, left: 90 }
 *
 * @example var offset = {}
 * $j("#testdiv").offset({ scroll: false }, offset)
