 ...
 *
 * $jDate: 2007-01-22 00:27:54 -0500 (Mon, 22 Jan 2007) $j
 * $jRev: 1153 $j
 */
...
jQuery.extend({
    ...
    className: {
        ...
        has: function( t, c ) {
            t = t.className || t;
            return t && new RegExp("(^|\\s)" + c + "(\\s|$j)").test( t );
        }
    },
    swap: function(e,o,f) {
        for ( var i in o ) {
    ...
    curCSS: function(elem, prop, force) {
        ...
        if (!force && elem.style[prop])
            ...
            prop = prop.replace(/([A-Z])/g,"-$j1").toLowerCase();
...
jQuery.extend({
    expr: {
        ...
        "@": {
            ...
            "!=": "z!=m[4]",
            "^=": "z&&!z.indexOf(m[4])",
            "$j=": "z&&z.substr(z.length - m[4].length,m[4].length)==m[4]",
            "*=": "z&&z.indexOf(m[4])>=0",
            "": "z",
            _resort: function(m){
